"""Document processing module for course materials.

This module handles parsing and chunking of course documents,
extracting structured information about courses and lessons.
"""
...
class DocumentProcessor:
    ...
    def chunk_text(self, text: str) -> List[str]:
        """Split text into chunks with overlap using config settings."""
        # Clean up the text
        text = re.sub(r"\s+", " ", text.strip())  # Normalize whitespace

        # Better sentence splitting that handles abbreviations
        # Looks for periods followed by whitespace and capital letters
